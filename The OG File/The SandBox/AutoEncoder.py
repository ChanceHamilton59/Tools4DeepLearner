...
@author: Chance Hamilton

Description: This is a generic Autoencoder that can be used for a range of tasks
             This autoencoder has two layers that will compress images to a lower
             deminsional space then reconstruct them
...
##############################################################################
# This section will import the MNIST Data set and break the set up into training
# and testing
##############################################################################
